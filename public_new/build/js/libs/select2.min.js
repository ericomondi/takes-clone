!function(e) {
    ...
    var t = function() {
        ...
        function(e) {
            var t, r, s, a, l = {}, c = {}, u = {}, d = {}, p = Object.prototype.hasOwnProperty, h = [].slice, f = /\.js$/;
            function g(e, t) {
                return p.call(e, t)
            }
            function m(e, t) {
                var n, i, o, r, s, a, l, c, d, p, h, g = t && t.split("/"), m = u.map, v = m && m["*"] || {};
                if (e) {
            ...
            s = function(e, t) {
                var n, i, o = _(e), r = o[0], s = t[1];
                return e = o[1],
                r && (n = w(r = m(r, s))),
                r ? e = n && n.normalize ? n.normalize(e, (i = s,
                function(e) {
                    return m(e, i)
                }
                )) : m(e, s) : (r = (o = _(e = m(e, s)))[0],
                e = o[1],
                r && (n = w(r))),
                {
                    f: r ? r + "!" + e : e,
            ...
            t = function(t, n, i, o) {
                var r, u, p, h, f, m, _, b = [], x = typeof i;
                if (m = $(o = o || t),
                "undefined" === x || "function" === x) {
                    ...
                    t && (r && r.exports !== e && r.exports !== l[t] ? l[t] = r.exports : p === e && _ || (l[t] = p))
                } else
                    t && (l[t] = i)
            }
            ,
            n = i = r = function(n, i, o, l, c) {
                ...
                l = c),
                l ? t(e, n, i, o) : setTimeout(function() {
                    t(e, n, i, o)
                }, 4),
                r
            }
        ...
        t.define("select2/results", ["jquery", "./utils"], function(e, t) {
            ...
            n.prototype.highlightFirstItem = function() {
                this.$results.find(".select2-results__option[aria-selected]").filter("[aria-selected=true]");
            ...
            n.prototype.ensureHighlightVisible = function() {
                ...
                if (0 !== e.length) {
                    var t = this.$results.find("[aria-selected]").index(e)
                      ...
                      , r = i - n;
                    o -= 2 * e.outerHeight(!1),
                    t <= 2 ? this.$results.scrollTop(0) : (r > this.$results.outerHeight() || r < 0) && this.$results.scrollTop(o)
                }
            }
            ,
        ...
        t.define("select2/data/tags", ["jquery"], function(e) {
            ...
            return t.prototype.query = function(e, t, n) {
                var i = this;
                this._removeOldTags(),
                null != t.term && null == t.page ? e.call(this, t, function e(o, r) {
        ...
        r = function(e) {
            ...
            function l(i) {
                var o, s = i || window.event, l = r.call(arguments, 1), d = 0, p = 0, h = 0, f = 0, g = 0;
                ...
                "axis"in s && s.axis === s.HORIZONTAL_AXIS && (p = -1 * h,
                h = 0),
                d = 0 === h ? p : h,
                "deltaY"in s && (d = h = -1 * s.deltaY),
                "deltaX"in s && (p = s.deltaX,
                0 === h && (d = -1 * p)),
                0 !== h || 0 !== p) {
                    if (1 === s.deltaMode) {
                    ...
                    if (o = Math.max(Math.abs(h), Math.abs(p)),
                    (!n || o < n) && (n = o,
                    u(s, o) && (n /= 40)),
                    u(s, o) && (d /= 40,
                    p /= 40,
        ...
        ,
        "function" == typeof t.define && t.define.amd ? t.define("jquery-mousewheel", ["jquery"], r) : "object" == typeof exports ? module.exports = r : r(e),
